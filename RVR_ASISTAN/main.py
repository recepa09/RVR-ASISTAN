...
def response(voice):
        ...
        if "not et" in voice:
            ...
            f.close()
            print("Kayıt başaralı uygulamayı kapattıktan sonra metin belgeniz oluşturulacaktır"),speak("Kayıt başaralı uygulamayı kapattıktan sonra metin belgeniz oluşturulacaktır")
